...
public class Initializer {
    public static ArrayList<Catalog> getData() {
        ...
        objCatalog = new Catalog(2, "Hospital", R.string.icon_hospital, 1);
        catalogCollection.add(objCatalog);
        objCatalog = new Catalog(3, "Pharmacy", R.string.icon_pharmacy, 1);
        catalogCollection.add(objCatalog);
        objCatalog = new Catalog(4, "Diagnostic Centre", R.string.icon_diagnosis, 1);
        catalogCollection.add(objCatalog);
        objCatalog = new Catalog(5, "Pet clinic", R.string.icon_petclinic, 1);
        catalogCollection.add(objCatalog);
        objCatalog = new Catalog(6, "Gymnasium", R.string.icon_gymnasium, 1);
        catalogCollection.add(objCatalog);
